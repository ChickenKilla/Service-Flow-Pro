...
const newDashboard = `{currentRoute === 'dashboard' && (
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div className="xl:col-span-8 flex flex-col gap-6">
              ...
              {/* Calendar Widget */}
              <div className="luxury-card p-6 flex-1 flex flex-col">
              ...
              <div className="flex flex-col gap-5">
                ...
                {customers.filter(c => !c.completed && isSameDay(parseISO(c.appointmentTime), selectedDate)).length > 3 && (
                  <div className="text-center py-3 border border-border border-dashed bg-surface/50 rounded-sm">
                    <p className="text-[10px] uppercase tracking-widest font-bold text-text-secondary">+ {customers.filter(c => !c.completed && isSameDay(parseISO(c.appointmentTime), selectedDate)).length - 3} more jobs</p>
                  </div>
                )}
              </div>
            </div>
